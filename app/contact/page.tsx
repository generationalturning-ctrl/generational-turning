...
export default async function ContactPage() {
  ...
  const subtitle = contact?.subtitle || "Questions about a pen, a custom order, or anything else — reach out.";
  const handle = contact?.instagramHandle || "generational_turning";
    ...
    <div className="min-h-screen py-16 px-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-white/50 mt-4">{subtitle}</p>
        </div>
